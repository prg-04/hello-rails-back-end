...
**hello-rails-back-end:** is a hello world project using rails and react.

[React repo](https://github.com/prg-04/hello-react-front-end)
...
```sh
  git clone https://github.com/prg-04/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/prg-04/hello-rails-back-end/issues).
